...
def submit_contact():
    ...
    is_member = request.form.get('is_member', 'no')  # Default to 'no' if not checked
    # Process the data...
...
def get_bot_response(user_input):
    ...
    return responses.get(user_input.lower(), "Hey there! Welcome to FitFusion! While I may not have all the answers, I'm here to support you in reaching your fitness goals. Whether it's losing weight, building muscle, or improving your overall health, I'm here to help! Feel free to ask me anything fitness-related, and let's crush those goals together!")
